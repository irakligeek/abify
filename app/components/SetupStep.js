  ...
  return (
    ...
    >
      <div className={`flex-shrink-0 rounded-full w-8 h-8 flex items-center justify-center font-semibold text-sm transition-colors duration-300 ${
        completed ? 'bg-[#4285F4] text-white' : 'bg-[#161618] text-white'
      }`}>
        {completed ? (
      ...
      <div className="flex-grow">
        <div className={`font-semibold transition-colors duration-300 ${
          completed ? 'text-[#4285F4]' : 'text-[#333333]'
        }`}>
          {title}
        </div>
        <div className={`text-sm transition-colors duration-300 ${
          completed ? 'text-[#4285F4]/80' : 'text-[#333333]/70'
        }`}>
          {description}
        </div>
      </div>
      {completed && (
        <div className="flex-shrink-0 ml-auto">
          <div className="w-6 h-6 bg-[#4285F4] rounded-full flex items-center justify-center animate-scale-in">
